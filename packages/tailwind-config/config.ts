...
export const config: Config = {
  darkMode: ['class'],
  content: [
    './node_modules/@founderswap/design-system/components/**/*.{ts,tsx}',
    './node_modules/@founderswap/design-system/lib/**/*.{ts,tsx}',
    './node_modules/@founderswap/design-system/index.tsx',
    './components/**/*.{ts,tsx}',
    './lib/**/*.{ts,tsx}',
    './app/**/*.{ts,tsx}',
    './pages/**/*.{tsx,mdx}',
