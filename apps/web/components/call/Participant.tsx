...
>(({ user }, ref) => {
  ...
  return (
    <div
      className="shrink grow basis-[calc(var(--flex-container-width)_-_var(--gap)_*_3)] text-base"
      ref={ref}
    >
      <Flipped flipId={id + pinned}>
        <div
          className={cn(
            'mx-auto h-full animate-fadeIn overflow-hidden text-white opacity-0',
        ...
        >
          {!isScreenShare && (
            <div
              className={cn(
                'absolute inset-0 grid h-full w-full place-items-center'
              )}
            >
              <div className="relative grid h-[2em] w-[2em] place-items-center text-4xl md:text-6xl 2xl:text-8xl">
                {data?.photob64 ? (
                  <div>
                    <AudioGlow
                  ...
                  <span className="relative grid h-full w-full place-items-center rounded-full bg-zinc-500 uppercase">
                    {isSpeaking && (
                      <AudioGlow
                        type="text"
          ...
          />
          {!isScreenShare && (
            <HoverFade className="absolute inset-0 grid h-full w-full place-items-center">
              <div className="flex gap-2 rounded bg-zinc-900/30 p-2">
          ...
          {data?.displayName && user.transceiverSessionId && (
            <div className="absolute bottom-1 left-1 m-2 flex items-center gap-2 text-shadow">
              ...
              <Tooltip content="Hand is raised">
                <div className="relative">
                  <div className="relative">
                    ...
                    <Icon
                      className="absolute top-0 left-0 animate-ping text-orange-300"
                      type="handRaised"
                    />
